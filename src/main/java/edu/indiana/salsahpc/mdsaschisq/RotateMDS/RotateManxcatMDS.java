...
public class RotateManxcatMDS
{
	...
	public static void SetupRotateMDS()
	{
		...
		{
			SALSAUtility.SALSAPrint(2, " Reference Points Taken from basic Labels File " + ManxcatCentral.Configuration.DataLabelsFileName);
		}
		else
		{
...
//                    RotationFileName = ManxcatCentral.Configuration.ControlDirectoryName + "\\" + RotationFileName;
	...
	public static void WriteRotateMDS(String fname, int OutputOption, double[][] param, double[][] perr)
	{
		...
		if (OutputOption == 0)
		{
			...
			SALSALibrary.SALSA_Properties.WriteDataPointFile(fname, ManxcatCentral.Configuration.Write2Das3D, "all ", RotationFileProperties, RotationPointProperties, SALSAUtility.NumberOriginalPoints);
			return;
		}
