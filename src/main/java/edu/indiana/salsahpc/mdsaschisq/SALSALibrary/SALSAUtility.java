...
//        public static HiPerfTimer[] SubTimers;   // Timing Objects
	...
	public static void SetupDistanceWeights()
	{
		...
		if (!tangible.DotNetToJavaStringHelper.isNullOrEmpty(ManxcatCentral.Configuration.DistanceWeightsCuts))
		{
			char[] sep = new char[] {','};
			String[] weightCuts = ManxcatCentral.Configuration.DistanceWeightsCuts.trim().split(java.util.regex.Pattern.quote(sep.toString()), -1);
